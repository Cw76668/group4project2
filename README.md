...
# ANALYSIS 
After analyzing the data, we are able to concur that in comparison to the first three months of 2024, the first three months of 2025 had a significantly lower crime rate. The total count in 2024 amounts to 52,616 while the total count in 2025 amounts to 257. This is roughly 200 times smaller than the amount of crimes in 2024. We were also able to find that crime decreased disproportionately with there being less crime overall but noticed that there was a particularly large decrease in central and west LA specifically. We can also draw to the conclusion that this may be due to the effectiveness of new distrtict attorney Nathan Hochman. After being sworn into office on December 3rd, 2024, Hochman focused much of his attention on the prioritization and implementation  of policies that enforced LAPD focus on high-crime zones. It should be noted that this contrast in data may not be as dramatic as it seems - because the 2025 data is relatively new, there is a possibility that there have been many more crimes that have been committed but not yet reported, or even both committed and reported, but not yet uploaded to this database. This introduces potential time bias.
